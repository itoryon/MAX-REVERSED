...
# direct methods
.method public constructor <init>(Litb;Lorg/webrtc/CameraVideoCapturer;Lsr;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V
    .locals 4
    ...
    iput-object v1, p0, Lye2;->b:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Lye2;->f:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lye2;->g:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-object v2, p0, Lye2;->h:Ljava/lang/String;

    iput-object p7, p0, Lye2;->e:Lh8e;
    ...
    invoke-direct {v3, p1}, Lvi2;-><init>(Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V

    invoke-direct {v2, p2, v3, p1}, Lyrc;-><init>(Lorg/webrtc/CameraVideoCapturer;Lvi2;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V

    const/16 p1, 0x17

    invoke-direct {p7, p1, v2}, Ltz8;-><init>(ILjava/lang/Object;)V

    iput-object p7, p0, Lye2;->c:Ltz8;

    iput-object p3, p0, Lye2;->d:Lsr;

    invoke-virtual {v0, p4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v1, p5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iput-boolean p6, p0, Lye2;->i:Z
...
.method public final a()V
    ...
    :try_start_0
    iget-boolean v1, p0, Lye2;->i:Z

    if-eqz v1, :cond_0

    iget-object v2, p0, Lye2;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v2, p0, Lye2;->b:Ljava/util/ArrayList;
    ...
    invoke-interface {v0, v3, v4}, Lh8e;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v3}, Ly0g;-><init>(I)V
    ...
    invoke-static {v7, v2, v8, v9, v6}, Ljv4;->x(IILjava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-interface {v5, v6, v2}, Lh8e;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v4, v3, v8}, Ljv4;->l(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, p0, Lye2;->e:Lh8e;

    new-instance v8, Ljava/lang/IllegalArgumentException;

    invoke-direct {v8, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v7, v6, v4, v8}, Lh8e;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Lye2;->e:Lh8e;

    const-string v7, "changeFormat, "

    const-string v8, "@"

    invoke-static {v7, v2, v5, v0, v8}, Lrv1;->p(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v4, v6, v7}, Lh8e;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lye2;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v8, v7, Lie9;->r:Lye2;

    if-eq p0, v8, :cond_d

    iget-object v8, v7, Lie9;->n:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    invoke-interface {v8, v10, v11, v9}, Lh8e;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v7, v7, Lie9;->y:Ldaj;

    iget-object v8, v7, Ld5a;->a:Lh8e;

    const-string v9, "VideoRecord"

    const-string v10, "Camera capture dimensions were changed to "

    invoke-static {v10, v2, v0, v5}, Ljv4;->l(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v8, v9, v10}, Lh8e;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v7, Ldaj;->l:Lorg/webrtc/Size;
    ...
    invoke-virtual {v7}, Ldaj;->p()V

    goto :goto_6

    :cond_e
    iget-boolean v4, p0, Lye2;->k:Z
    ...
    invoke-interface {v4, v6, v5}, Lh8e;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, p0, Lye2;->c:Ltz8;

    iget-object v4, v4, Ltz8;->b:Ljava/lang/Object;

    check-cast v4, Lyrc;

    invoke-virtual {v4, v2, v0, v3}, Lyrc;->changeCaptureFormat(III)V
    ...
    invoke-virtual {v0, v3, v4, v5}, Lyrc;->startCapture(III)V

    iput-boolean v1, p0, Lye2;->k:Z
    :try_end_1
    ...
    invoke-interface {p0, v2, v1, v0}, Lh8e;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lyrc;->stopCapture()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lye2;->k:Z
    :try_end_0
