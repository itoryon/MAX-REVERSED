...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V
    ...
    iput-object p1, p0, Lrs1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    iput-object p2, p0, Lrs1;->b:Lorg/webrtc/EglBase$Context;

    const-string v1, "CallOpenGL_renderer_"

    move-object v8, p4

    invoke-static {v1, p4}, Lrv1;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lrs1;->d:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v5}, Lns1;-><init>(Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Landroid/opengl/EGLContext;[ILmzj;Ljava/lang/String;)V

    iput-object v0, p0, Lrs1;->e:Lns1;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lrs1;->f:Landroid/graphics/Matrix;

    new-instance v0, Lorg/webrtc/VideoFrameDrawer;

    invoke-direct {v0}, Lorg/webrtc/VideoFrameDrawer;-><init>()V

    iput-object v0, p0, Lrs1;->g:Lorg/webrtc/VideoFrameDrawer;

    new-instance v0, Lorg/webrtc/GlRectDrawer;

    invoke-direct {v0}, Lorg/webrtc/GlRectDrawer;-><init>()V

    iput-object v0, p0, Lrs1;->h:Lorg/webrtc/GlRectDrawer;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lrs1;->i:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lrs1;->a(Lsb;)V

    iput-object v0, p0, Lrs1;->c:Lsb;
...
.method public final a(Lsb;)V
    ...
    iget-object p0, p0, Lrs1;->e:Lns1;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    :try_start_0
    iget-object v0, p0, Lns1;->k:Lw9k;
...
.method public final b()V
    ...
    iget-object v1, p0, Lns1;->j:Ljava/lang/String;
    ...
    iget-object v1, p0, Lns1;->h:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v2, p0, Lns1;->i:Z

    if-nez v2, :cond_0

    iget-object v2, p0, Lns1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    iget-object p0, p0, Lns1;->j:Ljava/lang/String;

    const-string v3, "Already released, ignore"

    invoke-interface {v2, p0, v3}, Lh8e;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    iput-boolean v2, p0, Lns1;->i:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    monitor-exit v1

    iget-object v1, p0, Lns1;->k:Lw9k;

    new-instance v2, Lre;

    const/16 v3, 0x16

    invoke-direct {v2, p0, v3, v0}, Lre;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v1, v2}, Landroid/os/Handler;->postAtFrontOfQueue(Ljava/lang/Runnable;)Z

    iget-object v1, p0, Lns1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    iget-object p0, p0, Lns1;->j:Ljava/lang/String;

    const-string v2, "Release action submitted"

    invoke-interface {v1, p0, v2}, Lh8e;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final c(Lns1;Lk72;Lorg/webrtc/VideoFrame;Lqw1;)V
    .locals 16
    ...
    iget-object v4, v2, Los1;->a:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {v1, v4}, Lns1;->b(Landroid/opengl/EGLSurface;)V

    const-string v7, "makeCurrent()"

    invoke-static {v7}, Lns1;->a(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Lrs1;->f:Landroid/graphics/Matrix;
    ...
    iget-object v3, v2, Lk72;->k:Lorg/webrtc/RendererCommon$GlDrawer;

    if-nez v3, :cond_3

    iget-object v3, v0, Lrs1;->h:Lorg/webrtc/GlRectDrawer;

    :cond_3
    move-object v10, v3

    iget-object v3, v1, Lns1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v8, v0, Lrs1;->g:Lorg/webrtc/VideoFrameDrawer;
    ...
    invoke-static {v0}, Lns1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v7

    iget-object v0, v1, Lns1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v1, v2, Lk72;->l:Ll72;

    sub-long v5, v3, v5

    sub-long/2addr v3, v7

    iget-wide v7, v1, Ll72;->h:J

    add-long/2addr v7, v5

    iput-wide v7, v1, Ll72;->h:J

    iget-wide v5, v1, Ll72;->i:J

    add-long/2addr v5, v3

    iput-wide v5, v1, Ll72;->i:J
