...
.method public constructor <init>(Lc19;Lc19;Lc19;)V
    ...
    iput-object p3, p0, Lorc;->a:Lc19;

    iput-object p1, p0, Lorc;->b:Lc19;

    iput-object p2, p0, Lorc;->c:Lc19;
    ...
    iput-object p1, p0, Lorc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    iput-object p1, p0, Lorc;->e:Lnrc;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lorc;->f:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    return-void
.end method

.method public static f(Ldbj;)Lmrc;
    .locals 2

    new-instance v0, Lmrc;

    iget-object v1, p0, Ldbj;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
    ...
    iget-object p0, p0, Ldbj;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Ljbj;

    move-result-object p0

    invoke-direct {v0, v1, p0}, Lmrc;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ljbj;)V
...
.method public final clear()V
    ...
    iget-object v0, p0, Lorc;->f:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2, v3}, Ls72;->e(Z)V

    const/4 v3, 0x0

    iput-object v3, v2, Ls72;->j:Lawi;

    const/4 v3, 0x0

    iput-boolean v3, v2, Ls72;->k:Z

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lorc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/video/VideoRender;->clear()V

    iget-object p0, p0, Lorc;->e:Lnrc;
...
.method public final createVideoViewInstance(Landroid/content/Context;)Lru/ok/android/externcalls/sdk/ui/RendererView;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;IILdb5;)V
...
.method public final getOwnVideoTrack()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
    ...
    invoke-virtual {p0}, Lorc;->e()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final h(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    ...
    iget-object p0, p0, Lorc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final onCameraChanged()V
    ...
    iget-object v3, v1, Ls72;->l:Ldbj;

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Ldbj;->c:Z

    const/4 v4, 0x1

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Ls72;->d:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lorc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0}, Lorc;->g()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    move-result-object v0

    invoke-virtual {p0, v0, p1}, Lorc;->h(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lorc;->h(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lorc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    invoke-static/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init$default(Lru/ok/android/externcalls/sdk/ui/RendererView;Lrs1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;ILjava/lang/Object;)Z
