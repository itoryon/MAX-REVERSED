...
# direct methods
.method public constructor <init>(Lh8e;Lzye;)V
    .locals 2
    ...
    iput-object v0, p0, Lwe7;->j:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Lwe7;->b:Lh8e;

    iput-object p2, p0, Lwe7;->c:Lzye;
    ...
    iput-object p1, p0, Lwe7;->a:Ljs4;

    new-instance p1, Lfzh;

    invoke-direct {p1}, Lfzh;-><init>()V

    iput-object p1, p0, Lwe7;->h:Lfzh;

    new-instance p1, Lfzh;

    invoke-direct {p1}, Lfzh;-><init>()V

    iput-object p1, p0, Lwe7;->i:Lfzh;
...
.method public final a()V
    ...
    iget-object v0, p0, Lwe7;->d:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iput-wide v2, p0, Lwe7;->g:J

    :cond_0
    iget-object v0, p0, Lwe7;->e:Lkf7;

    if-eqz v0, :cond_3

    iget-object p0, p0, Lwe7;->e:Lkf7;
    ...
    iput-boolean v0, p0, Lkf7;->h:Z

    :cond_2
    iget-object v0, p0, Lkf7;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v0, p0, Lkf7;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lkf7;->g:Leak;

    invoke-static {p0}, Lkf7;->b(Leak;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Lwe7;->f:Lkf7;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Lwe7;->l:J
    ...
    iget-object v5, v2, Lkf7;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Lkf7;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Lwe7;->j:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Lh8e;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Lwe7;->l:J

    iget-object p1, p0, Lwe7;->j:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Lwe7;->a:Ljs4;

    new-instance v0, Loa6;

    const/4 v3, 0x7

    invoke-direct {v0, p0, v2, v1, v3}, Loa6;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-virtual {p1, v0}, Ljs4;->b(Ljava/lang/Runnable;)V

    return-void

    :catch_0
    iget-object p0, p0, Lwe7;->b:Lh8e;
...
.method public final onFrameDropped(I)V
    ...
    iget-object p0, p0, Lwe7;->i:Lfzh;

    invoke-virtual {p0}, Lfzh;->a()V
