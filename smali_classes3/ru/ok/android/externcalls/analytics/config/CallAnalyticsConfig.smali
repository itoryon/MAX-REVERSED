...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "upload",
        "<init>",
        "(Lzvb;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V",
        "Lzvb;",
        "getOkApi",
        "()Lzvb;",
        "Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;",
...
.field private final okApi:Lzvb;

.field private final upload:Lru/ok/android/externcalls/analytics/config/UploadConfig;


# direct methods
.method public constructor <init>(Lzvb;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V
    .locals 0
    ...
    .line 68
    iput-object p1, p0, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->okApi:Lzvb;
...
.method public synthetic constructor <init>(Lzvb;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;ILdb5;)V
    .locals 20
    ...
    invoke-direct {v0, v2, v1, v2}, Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;-><init>(Lqh7;ILdb5;)V
    ...
    invoke-direct/range {v3 .. v19}, Lru/ok/android/externcalls/analytics/config/UploadConfig;-><init>(ILjava/util/concurrent/Executor;JJLqh7;Lqh7;Lqh7;Lqh7;Lqh7;Lqh7;Lqh7;Lqh7;ILdb5;)V
    ...
    :goto_3
    invoke-direct {v2, v4, v0, v1, v3}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;-><init>(Lzvb;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V
...
.method public final getOkApi()Lzvb;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->okApi:Lzvb;
