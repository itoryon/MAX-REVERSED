...
.method public static fromExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lzt1;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-virtual {v0, p0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setInternalId(Lzt1;)V

    :cond_0
    return-object v0
.end method

.method public static fromInternal(Lzt1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    .locals 1
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lzt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
# virtual methods
.method public deAnonymize(Leu1;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Leu1;
...
.method public getAcceptCallEpochMs()J
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Leu1;

    if-eqz p0, :cond_0

    iget-wide v0, p0, Leu1;->n:J
...
.method public getAcceptedCallClientType()Ljava/lang/String;
    ...
    :cond_0
    iget-object p0, p0, Leu1;->l:Ljava/lang/String;
...
.method public getAcceptedCallPlatform()Ljava/lang/String;
    ...
    :cond_0
    iget-object p0, p0, Leu1;->m:Ljava/lang/String;

    return-object p0
.end method

.method public getAudioOptionState()Ln3a;
    .locals 0
...
.method public getCallParticipant()Leu1;
    .locals 0
...
.method public getCapabilities()Lru/ok/android/externcalls/sdk/capabilities/ClientCapabilities;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Leu1;
...
.method public getInternalId()Lzt1;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lzt1;
...
.method public getMovies()Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Leu1;->r:Ljava/util/List;

    return-object p0
.end method

.method public getNetworkStatus()Lwgb;
    .locals 0
    ...
    :cond_0
    iget-object p0, p0, Leu1;->j:Lwgb;

    return-object p0
.end method

.method public getScreenshareOptionState()Ln3a;
    .locals 0
...
.method public getVideoOptionState()Ln3a;
    .locals 0
...
.method public getWatchTogetherOptionState()Ln3a;
    .locals 0
...
.method public hasRegisteredPeers()Z
    ...
    iget-object p0, p0, Leu1;->f:Ljava/util/HashMap;
...
.method public setCallParticipant(Leu1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lzt1;
...
.method public setDeviceIndex(ILru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    :cond_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lzt1;

    if-eqz v0, :cond_1

    new-instance v1, Lzt1;

    iget-wide v2, v0, Lzt1;->a:J

    iget v0, v0, Lzt1;->b:I

    invoke-direct {v1, v0, p1, v2, v3}, Lzt1;-><init>(IIJ)V

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lzt1;
    ...
    iget-wide v3, v1, Lzt1;->a:J

    iget v1, v1, Lzt1;->b:I

    invoke-direct {v2, v1, p1, v3, v4}, Lzt1;-><init>(IIJ)V

    iput-object v2, v0, Leu1;->a:Lzt1;

    iget-object v1, v0, Leu1;->q:Lhi1;
...
.method public setInternalId(Lzt1;)V
    .locals 0
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lzt1;
