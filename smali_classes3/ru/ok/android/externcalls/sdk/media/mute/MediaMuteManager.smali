...
.method public static synthetic getMediaOptionsForCall$default(Lru/ok/android/externcalls/sdk/media/mute/MediaMuteManager;Llrf;ILjava/lang/Object;)Lo3a;
    ...
    :cond_0
    invoke-interface {p0, p1}, Lru/ok/android/externcalls/sdk/media/mute/MediaMuteManager;->getMediaOptionsForCall(Llrf;)Lo3a;
...
.method public static synthetic requestToEnableMediaForAll$default(Lru/ok/android/externcalls/sdk/media/mute/MediaMuteManager;Ljava/util/Set;Llrf;Lqh7;Lsh7;ILjava/lang/Object;)V
    ...
    :cond_2
    invoke-interface {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/media/mute/MediaMuteManager;->requestToEnableMediaForAll(Ljava/util/Set;Llrf;Lqh7;Lsh7;)V
...
.method public static synthetic requestToEnableMediaForParticipant$default(Lru/ok/android/externcalls/sdk/media/mute/MediaMuteManager;Ljava/util/Set;Lru/ok/android/externcalls/sdk/id/ParticipantId;Llrf;Lqh7;Lsh7;ILjava/lang/Object;)V
    ...
    :cond_2
    invoke-interface/range {p0 .. p5}, Lru/ok/android/externcalls/sdk/media/mute/MediaMuteManager;->requestToEnableMediaForParticipant(Ljava/util/Set;Lru/ok/android/externcalls/sdk/id/ParticipantId;Llrf;Lqh7;Lsh7;)V
...
.method public static synthetic updateMediaOptionsForAll$default(Lru/ok/android/externcalls/sdk/media/mute/MediaMuteManager;Ljava/util/Map;Llrf;Lqh7;Lsh7;ILjava/lang/Object;)V
    ...
    :cond_2
    invoke-interface {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/media/mute/MediaMuteManager;->updateMediaOptionsForAll(Ljava/util/Map;Llrf;Lqh7;Lsh7;)V
...
.method public static synthetic updateMediaOptionsForParticipant$default(Lru/ok/android/externcalls/sdk/media/mute/MediaMuteManager;Ljava/util/Map;Lru/ok/android/externcalls/sdk/id/ParticipantId;Llrf;Lqh7;Lsh7;ILjava/lang/Object;)V
    ...
    :cond_2
    invoke-interface/range {p0 .. p5}, Lru/ok/android/externcalls/sdk/media/mute/MediaMuteManager;->updateMediaOptionsForParticipant(Ljava/util/Map;Lru/ok/android/externcalls/sdk/id/ParticipantId;Llrf;Lqh7;Lsh7;)V
...
.method public abstract getMediaOptionsForCall(Llrf;)Lo3a;
.end method

.method public abstract getMediaOptionsForCurrentUser()Lo3a;
.end method

.method public abstract removeListener(Lru/ok/android/externcalls/sdk/media/mute/listener/MediaMuteManagerListener;)V
.end method

.method public abstract requestToEnableMediaForAll(Ljava/util/Set;Llrf;Lqh7;Lsh7;)V
...
.method public abstract requestToEnableMediaForParticipant(Ljava/util/Set;Lru/ok/android/externcalls/sdk/id/ParticipantId;Llrf;Lqh7;Lsh7;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/Set<",
...
.method public abstract updateMediaOptionsForAll(Ljava/util/Map;Llrf;Lqh7;Lsh7;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/Map<",
...
.method public abstract updateMediaOptionsForParticipant(Ljava/util/Map;Lru/ok/android/externcalls/sdk/id/ParticipantId;Llrf;Lqh7;Lsh7;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/Map<",
