...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lh8e;)V",
        "Lo91;",
        "call",
        "Lfii;",
        "setCall",
        ...
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lqcg;",
        "Lx72;",
        "fromId",
        "Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$WaitingParticipantsPage;",
        ...
        "internalId",
        "fromInternalLong",
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lzt1;)Lx72;",
        "",
        "Lw72;",
        "waitingParticipants",
        "Lkotlin/Function1;",
...
.field private final compositeDisposable:Lp94;
...
.field private final loadEventSubject:Ly2e;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Companion;-><init>(Ldb5;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lh8e;)V
    .locals 2
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Lh8e;

    new-instance p1, Ly2e;

    invoke-direct {p1}, Ly2e;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Ly2e;

    new-instance p2, Lp94;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lp94;
    ...
    invoke-direct {v0, p1, p4, v1}, Ldub;-><init>(Lztb;Lm7f;I)V

    invoke-static {}, Lv7f;->b()Lm7f;

    move-result-object p1

    invoke-virtual {v0, p1}, Lztb;->e(Lm7f;)Lpub;
    ...
    invoke-direct {v0, p1, p4, v1}, Lrub;-><init>(Lztb;Lii7;I)V
    ...
    invoke-direct {p1, p3}, Lwi7;-><init>(Ljava/lang/Object;)V

    new-instance p3, Lmub;

    invoke-direct {p3, v0, p1, v1}, Lmub;-><init>(Lztb;Ljava/lang/Object;I)V

    invoke-static {}, Luh;->a()Lm7f;

    move-result-object p1

    invoke-virtual {p3, p1}, Lztb;->e(Lm7f;)Lpub;
    ...
    sget-object p0, Lnp9;->f:Lgq2;

    new-instance p4, Lk09;

    invoke-direct {p4, p3, p0}, Lk09;-><init>(Lli4;Lli4;)V

    invoke-virtual {p1, p4}, Lztb;->f(Llvb;)V

    invoke-virtual {p2, p4}, Lp94;->a(Loq5;)Z

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ladg;Lp82;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$0$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ladg;Lp82;)V
...
.method public static synthetic b(Ladg;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$0$0(Ladg;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V

    return-void
.end method

.method public static synthetic c(Ladg;)V
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$0$1(Ladg;)V

    return-void
.end method

.method public static synthetic d(Lo91;Lx72;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lwcg;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$0(Lo91;Lx72;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ladg;)V

    return-void
.end method

.method public static synthetic e(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lwcg;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Ladg;)V

    return-void
.end method

.method private final fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lzt1;)Lx72;
    .locals 2
    ...
    invoke-direct {p0, p2, v0, v1}, Lx72;-><init>(Lzt1;J)V
...
.method private final getInternalIdsToResolve(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lzt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final getResolvedWaitingParticipantIds(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v2, v1, Lw72;->a:Lx72;

    iget-object v2, v2, Lx72;->b:Lzt1;
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lzt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final loadWaitingParticipantIds()Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipantsUpdate;
    ...
    :try_start_0
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lqcg;

    move-result-object v6

    invoke-virtual {v6}, Lqcg;->d()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lzt1;

    invoke-direct {p0, v3, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lzt1;)Lx72;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Lh8e;
    ...
    invoke-interface {v2, v4, v0}, Lh8e;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0, v0, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle(Lo91;Lx72;)Lqcg;
...
.method private final loadWaitingParticipantIdsPageSingle(Lo91;Lx72;)Lqcg;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p0, v1}, Lsdi;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$0(Lo91;Lx72;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ladg;)V
    .locals 7
    ...
    invoke-direct {v0, p2, v1, p3}, Lfo5;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p2, Lz8g;

    const/16 v1, 0x1b

    invoke-direct {p2, v1, p3}, Lz8g;-><init>(ILjava/lang/Object;)V

    iget-object p3, p0, Lo91;->k:Lk9g;
    ...
    iget-object v5, p1, Lx72;->b:Lzt1;

    invoke-virtual {v5}, Lzt1;->b()Ljava/lang/String;
    ...
    invoke-direct {p1, p0, v0, p2, v2}, Ly81;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p0, Lnb;

    invoke-direct {p0, v2, p2}, Lnb;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p3, v1, v4, p1, p0}, Lk9g;->d(Ln9g;ZLh9g;Lh9g;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$0$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ladg;Lp82;)V
    .locals 8

    iget-object v2, p2, Lp82;->a:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Ladg;Lp82;Ladg;)V
    ...
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$2;-><init>(Ladg;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$0$1(Ladg;)V
    .locals 2
    ...
    invoke-virtual {p0, v0}, Lwcg;->d(Ljava/lang/Throwable;)Z
...
.method private final putIdMappingsToCache(Ljava/util/List;)V
    ...
    iget-object v0, v0, Lw72;->a:Lx72;

    iget-object v0, v0, Lx72;->b:Lzt1;

    invoke-virtual {v2, v1, v0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lzt1;)V
...
.method private final resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lqcg;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final resolveInternalIdSingle$lambda$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Ladg;)V
    .locals 4
    ...
    invoke-direct {v1, v2, p2}, Lji4;-><init>(ILjava/lang/Object;)V

    new-instance v2, Ltih;

    const/16 v3, 0x1a

    invoke-direct {v2, p2, v3, p1}, Ltih;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lmi4;Ljava/lang/Runnable;)V

    return-void
.end method

.method private static final resolveInternalIdSingle$lambda$0$0(Ladg;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 3
...
.method private final resolveInternalIds(Ljava/util/List;Lsh7;Lsh7;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lsh7;Lsh7;)V

    new-instance p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;-><init>(Lsh7;)V
...
.method private final scheduleLoad()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Ly2e;

    sget-object v0, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    invoke-virtual {p0, v0}, Ly2e;->d(Ljava/lang/Object;)V
...
.method public final release()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lp94;
