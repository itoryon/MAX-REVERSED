...
.method private final getPosition(Ljava/lang/Long;)Ll5b;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lj5b;-><init>(J)V

    return-object p0

    :cond_1
    :goto_0
    sget-object p0, Lk5b;->a:Lk5b;
...
.method private final updateState(Lr5b;)V
    .locals 12
    ...
    iget-object p1, p1, Lr5b;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Lq5b;->a:Ln72;

    iget-object v3, v3, Ln72;->b:Lzt1;
    ...
    iget-object v11, v3, Ln72;->c:Li5b;
    ...
    sget-object v5, Lo5b;->$EnumSwitchMapping$1:[I
    ...
    iget-object v9, v8, Lf5b;->d:Ln5b;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Lf5b;->a:Li5b;

    invoke-virtual {v8, v11}, Li5b;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Lq5b;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Ll5b;

    move-result-object v5

    iget-boolean v2, v1, Lq5b;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Lq5b;->b:F

    invoke-static {v7}, Lv5b;->a(F)V

    iget-boolean v8, v1, Lq5b;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ll5b;ZFZLf5b;Ldb5;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Llrf;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Llrf;Lf5b;)V
...
.method public final onVideoStarted(Lp5b;)V
    .locals 12
    ...
    iget-object v11, v7, Lf5b;->a:Li5b;
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ll5b;ZFZLf5b;Ldb5;)V
    ...
    iget-object p1, p1, Lp5b;->b:Llrf;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Llrf;Lf5b;)V
...
.method public final onVideoStatesUpdatedChanged(Lr5b;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lr5b;)V
...
.method public final onVideoStopped(Ls5b;)V
    .locals 4
    ...
    iget-object v2, p1, Ls5b;->b:Llrf;

    iget-object v3, p1, Ls5b;->c:Li5b;

    iget-object p1, p1, Ls5b;->d:Ln5b;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Llrf;Li5b;Ln5b;)V
