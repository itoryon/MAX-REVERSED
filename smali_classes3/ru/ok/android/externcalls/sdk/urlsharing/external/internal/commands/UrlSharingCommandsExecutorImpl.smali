...
.method public static synthetic a(Lqh7;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->stop$lambda$0(Lqh7;Lorg/json/JSONObject;)V
...
.method public static synthetic b(Lsh7;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->start$lambda$1(Lsh7;Lorg/json/JSONObject;)V
...
.method public static synthetic c(Lqh7;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->start$lambda$0(Lqh7;Lorg/json/JSONObject;)V
...
.method public static synthetic d(Lsh7;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->stop$lambda$1(Lsh7;Lorg/json/JSONObject;)V
...
.method private static final start$lambda$0(Lqh7;Lorg/json/JSONObject;)V
    .locals 0
...
.method private static final start$lambda$1(Lsh7;Lorg/json/JSONObject;)V
    .locals 3
...
.method private static final stop$lambda$1(Lsh7;Lorg/json/JSONObject;)V
    .locals 3
...
# virtual methods
.method public start(Ljava/lang/String;Lqh7;Lsh7;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->getSignalingOrPassExceptionToOnError(Lsh7;)Lk9g;
    ...
    invoke-virtual {p0, v0, p1, p2}, Lk9g;->l(Lorg/json/JSONObject;Lh9g;Lh9g;)V

    return-void
.end method

.method public stop(Lqh7;Lsh7;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->getSignalingOrPassExceptionToOnError(Lsh7;)Lk9g;
    ...
    invoke-direct {v1, v2, p1}, Lnx;-><init>(ILqh7;)V

    new-instance p1, Lox;

    const/16 v2, 0x9

    invoke-direct {p1, v2, p2}, Lox;-><init>(ILsh7;)V

    invoke-virtual {p0, v0, v1, p1}, Lk9g;->l(Lorg/json/JSONObject;Lh9g;Lh9g;)V
