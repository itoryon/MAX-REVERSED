...
.method public final a(IILjava/lang/String;)Z
    ...
    :cond_0
    iget-object v1, p0, Lrl9;->j:Ljava/lang/String;

    if-eqz v1, :cond_1

    invoke-static {v1, p3}, Lzwk;->e(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_1
    iput-boolean v0, p0, Lrl9;->k:Z

    iput-object p3, p0, Lrl9;->j:Ljava/lang/String;
...
.method public final f()V
    ...
    iput-object v0, p0, Lrl9;->j:Ljava/lang/String;
...
.method public final onLoaded(Lone/me/rlottie/RLottieDrawable;)V
    ...
    invoke-static {p0, v0, p1}, Lhm0;->n(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final onNextFrameRendered(Lone/me/rlottie/RLottieDrawable;I)V
    ...
    iget-boolean p1, p0, Lrl9;->k:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Lrl9;->l:Lql9;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lql9;->c()V

    :cond_0
    const/4 p1, 0x0

    iput-boolean p1, p0, Lrl9;->k:Z

    :cond_1
    return-void
.end method

.method public final setFailureListener(Lpl9;)V
    .locals 0

    iput-object p1, p0, Lrl9;->m:Lpl9;

    return-void
.end method

.method public final setOnFirstFrameListener(Lql9;)V
    .locals 0

    iput-object p1, p0, Lrl9;->l:Lql9;
