...
# static fields
.field public static final j:[Ljbj;
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Ljbj;->b:Ljbj;

    filled-new-array {v0, v1}, [Ljbj;

    move-result-object v0

    sput-object v0, Lye5;->j:[Ljbj;
...
.method public constructor <init>(Lqtg;Lh8e;Lbtc;Ldp9;)V
    ...
    iput-object p1, p0, Lye5;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lye5;->g:Ljava/util/HashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lye5;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lye5;->i:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final a(Lzt1;Lorg/webrtc/VideoFrame;)V
    ...
    iget-object p0, p0, Lye5;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p1, p2}, Lnaj;->a(Lorg/webrtc/VideoFrame;)V
...
.method public final d()V
    ...
    invoke-direct {v1, v2, p0}, Lji4;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v0, p0, v1, v2}, Lcqk;-><init>(Ljtc;Lmi4;I)V
...
.method public final e(Lzt1;Ljava/lang/String;)V
    ...
    iput-object v1, v2, Ll0k;->c:Ljava/lang/Object;

    iput-object p1, v2, Ll0k;->b:Ljava/lang/Object;

    invoke-virtual {v2}, Ll0k;->p()Ln72;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {p0, p2, v1, v2}, Lye5;->n(Ljava/lang/String;Ln72;Ljava/util/List;)V
...
.method public final f()V
    ...
    :try_start_0
    iget-object v2, p0, Lye5;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v1, v4, Lnaj;->a:Lorg/webrtc/VideoSink;
...
.method public final j(Lorg/webrtc/RtpReceiver;[Lorg/webrtc/MediaStream;)V
    ...
    invoke-direct {p1, p0, v1, v2}, Lcqk;-><init>(Ljtc;Lmi4;I)V
...
.method public final n(Ljava/lang/String;Ln72;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lwe5;-><init>(Lye5;Ljava/lang/String;Ln72;Ljava/util/List;)V
...
.method public final p(Ljava/lang/String;Ln72;Ljava/util/List;)V
    .locals 6
    ...
    :try_start_0
    iget-object v3, p0, Lye5;->g:Ljava/util/HashMap;
    ...
    iput-object v4, v1, Lnaj;->a:Lorg/webrtc/VideoSink;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    iget-object p3, p0, Lye5;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lye5;->h:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Lye5;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p3, p0, Lye5;->i:Ljava/util/concurrent/ConcurrentHashMap;
