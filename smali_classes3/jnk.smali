...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Ljnk;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Ljnk;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v1, v0}, Lrlc;->e(ILjava/lang/String;)I
    ...
    invoke-static {v2, p1}, Lrlc;->e(ILjava/lang/String;)I
    ...
    iput v0, p0, Ljnk;->aVertexCoordLoc:I

    invoke-static {v0, p1}, Lrlc;->b(ILjava/lang/String;)V
    ...
    iput v1, p0, Ljnk;->aTextureCoordLoc:I

    invoke-static {v1, p1}, Lrlc;->b(ILjava/lang/String;)V
    ...
    iput v3, p0, Ljnk;->mvpMatrixLoc:I

    invoke-static {v3, p1}, Lrlc;->b(ILjava/lang/String;)V
    ...
    iput v3, p0, Ljnk;->texMatrixLoc:I
    ...
    iput v3, p0, Ljnk;->textureLocation:I
    ...
    iput v2, p0, Ljnk;->alphaLocation:I

    invoke-static {v3, p1}, Lrlc;->b(ILjava/lang/String;)V

    new-instance p1, Lslk;

    invoke-direct {p1, v0, v1}, Lslk;-><init>(II)V

    iput-object p1, p0, Ljnk;->frame:Lslk;
...
.method public getTextureCoordLoc()I
    ...
    iget p0, p0, Ljnk;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget p0, p0, Ljnk;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Ljnk;->firstFreeTexture:I
    ...
    invoke-static {p1}, Lrlc;->c(Ljava/lang/String;)V

    iget p1, p0, Ljnk;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Ljnk;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Ljnk;->frame:Lslk;

    iget-object v0, v0, Lslk;->a:Lank;

    invoke-interface {v0}, Lank;->a()V

    iget p0, p0, Ljnk;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Ljnk;->use()V

    iget-object v0, p0, Ljnk;->frame:Lslk;

    iget-object v0, v0, Lslk;->a:Lank;

    invoke-interface {v0}, Lank;->b()V

    invoke-virtual {p0}, Ljnk;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    iget v0, p0, Ljnk;->programId:I

    invoke-static {v0, p1}, Landroid/opengl/GLES20;->glGetUniformLocation(ILjava/lang/String;)I

    move-result p1

    iget-object p0, p0, Ljnk;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Ljnk;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Ljnk;->texMat:[F
...
.method public use()V
    ...
    iput v0, p0, Ljnk;->firstFreeTexture:I

    iget-object v1, p0, Ljnk;->mvpMat:[F
    ...
    iput-object v1, p0, Ljnk;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Ljnk;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Ljnk;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Ljnk;->programId:I

    invoke-static {v1}, Landroid/opengl/GLES20;->glUseProgram(I)V

    const-string v1, "glUseProgram"

    invoke-static {v1}, Lrlc;->c(Ljava/lang/String;)V

    iget v1, p0, Ljnk;->mvpMatrixLoc:I

    iget-object v2, p0, Ljnk;->mvpMat:[F
    ...
    iget v2, p0, Ljnk;->texMatrixLoc:I

    iget-object v4, p0, Ljnk;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Lrlc;->c(Ljava/lang/String;)V

    iget v0, p0, Ljnk;->textureLocation:I

    invoke-virtual {p0}, Ljnk;->getTarget()I

    move-result v1

    iget v2, p0, Ljnk;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Ljnk;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Ljnk;->alphaLocation:I

    iget v1, p0, Ljnk;->alpha:F
    ...
    iget-object v0, p0, Ljnk;->customParams:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Ljnk;->customParams:Ljava/util/HashMap;
