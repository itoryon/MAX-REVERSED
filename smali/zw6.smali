...
.method public static A0(Ljava/io/File;)[B
    ...
    invoke-direct {v6}, Lak6;-><init>()V

    invoke-virtual {v6, v5}, Ljava/io/OutputStream;->write(I)V

    invoke-static {v0, v6}, Ljnl;->b(Ljava/io/InputStream;Ljava/io/OutputStream;)V
...
.method public static B0(Ljava/io/File;)Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v3, v1}, Lax6;-><init>(ILjava/util/ArrayList;)V
    ...
    invoke-direct {v0, p0}, Lhh4;-><init>(Lxlf;)V

    invoke-virtual {v0}, Lhh4;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v2, v0}, Lax6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static C0(Ljava/io/File;Ljava/nio/charset/Charset;)Ljava/lang/String;
    .locals 2
...
.method public static D0(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1, v1, v2, v3}, Lgch;->W0(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {p1, v3}, Lgch;->P0(Ljava/lang/String;C)Z
    ...
    :cond_6
    invoke-static {p0, v1}, Lgch;->P0(Ljava/lang/String;C)Z
...
.method public static F0(Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {v1, p1, v0}, Lzw6;->G0(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static x0(Ljava/io/File;Ljava/io/File;)V
    .locals 2
    ...
    :try_start_1
    invoke-static {v0, p0}, Ljnl;->a(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public static y0(Ljava/io/File;)Z
    .locals 4

    new-instance v0, Lqv6;

    invoke-direct {v0, p0}, Lqv6;-><init>(Ljava/io/File;)V

    new-instance p0, Lov6;

    invoke-direct {p0, v0}, Lov6;-><init>(Lqv6;)V
...
.method public static z0(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v0, p0, v1}, Lgch;->t1(CLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
