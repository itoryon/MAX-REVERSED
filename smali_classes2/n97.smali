...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ln97;->b:Lqs0;

    return-void
.end method

.method public static a(Landroid/content/Context;Ljava/util/List;)Lqg5;
    .locals 5
    ...
    invoke-static {v3, v2, v4}, Ln97;->b(Landroid/content/pm/PackageManager;Lp97;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    invoke-static {p0, v2, v3}, Ln97;->c(Landroid/content/Context;Lp97;Ljava/lang/String;)[Lz97;
    ...
    invoke-direct {p0, v0}, Lqg5;-><init>(Ljava/util/ArrayList;)V
    :try_end_1
...
.method public static b(Landroid/content/pm/PackageManager;Lp97;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    .locals 9

    sget-object v0, Ln97;->b:Lqs0;

    sget-object v1, Ln97;->a:Lcm9;
    ...
    invoke-static {v4}, Lgr4;->c(Ljava/lang/String;)V

    :try_start_0
    iget-object v4, p1, Lp97;->d:Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v5, p1, Lp97;->a:Ljava/lang/String;

    iget-object p1, p1, Lp97;->b:Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    invoke-static {p2, v6}, Lc6m;->c(Landroid/content/res/Resources;I)Ljava/util/List;

    move-result-object v4

    :goto_0
    new-instance p2, Lm97;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object v5, p2, Lm97;->a:Ljava/lang/String;

    iput-object p1, p2, Lm97;->b:Ljava/lang/String;

    iput-object v4, p2, Lm97;->c:Ljava/util/List;

    invoke-virtual {v1, p2}, Lcm9;->c(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_5
    invoke-virtual {v1, p2, v7}, Lcm9;->d(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_2
...
.method public static c(Landroid/content/Context;Lp97;Ljava/lang/String;)[Lz97;
    .locals 18
    ...
    iget-object v0, v0, Lp97;->c:Ljava/lang/String;
    ...
    invoke-direct/range {v12 .. v17}, Lz97;-><init>(Landroid/net/Uri;IIZI)V
