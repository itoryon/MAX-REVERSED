...
# virtual methods
.method public final a(Lcfa;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Lcfa;

    invoke-virtual {p1}, Lcfa;->getIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ActionMenuItemView;->setIcon(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p1}, Lcfa;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1}, Lcfa;->isVisible()Z
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Lf8;

    if-nez p1, :cond_1

    new-instance p1, Lf8;

    invoke-direct {p1, p0}, Lf8;-><init>(Landroidx/appcompat/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Lf8;
...
.method public final d()Z
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Lcfa;

    invoke-virtual {p0}, Lcfa;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public getItemData()Lcfa;
    .locals 0
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lyea;

    if-eqz p1, :cond_0

    iget-object p0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Lcfa;

    invoke-interface {p1, p0}, Lyea;->b(Lcfa;)Z
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Lcfa;

    invoke-virtual {v0}, Lcfa;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Lf8;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, Lvc7;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public final r()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Lcfa;
    ...
    iget-object v2, v2, Lcfa;->q:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lcfa;->e:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lcfa;->r:Ljava/lang/CharSequence;
    ...
    iget-object v1, v0, Lcfa;->e:Ljava/lang/CharSequence;

    :goto_4
    invoke-static {p0, v1}, Ly1i;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    :cond_6
    invoke-static {p0, v2}, Ly1i;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public setItemInvoker(Lyea;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lyea;
...
.method public setPopupCallback(Lg8;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->m:Lg8;
