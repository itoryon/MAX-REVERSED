...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    invoke-direct/range {p0 .. p1}, Lv8a;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lgdg;->y:Lk2j;
    ...
    invoke-direct {v1, v0, v2}, Li1g;-><init>(Landroid/content/Context;I)V

    invoke-static {v5, v1}, Lg09;->F(ILqh7;)Lc19;

    move-result-object v0

    iput-object v0, p0, Lgdg;->H:Lc19;

    return-void
.end method

.method public static final P(Lgdg;Lg50;)V
    .locals 8

    iget-object v0, p0, Lgdg;->z:Lht9;
    ...
    :cond_7
    :goto_4
    invoke-direct {p0}, Lgdg;->getTransferStatusView()Ll0j;
...
.method public final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v4, v0, Lgdg;->B:Le5c;

    if-ne v2, v4, :cond_0

    iget-boolean v5, v0, Lgdg;->D:Z
    ...
    :cond_0
    iget-object v5, v0, Lgdg;->z:Lht9;

    if-eq v2, v5, :cond_2

    if-eq v2, v4, :cond_2

    iget-object v4, v0, Lgdg;->y:Lk2j;
...
.method public final q(Lit9;)V
    ...
    iget-object v1, p0, Lgdg;->z:Lht9;

    invoke-virtual {v1, v0}, Lj88;->setImageAttach(Lv78;)V

    invoke-direct {p0}, Lgdg;->getBlurPostProcessor()Luz0;

    move-result-object v1

    iget-object v2, p0, Lgdg;->B:Le5c;
    ...
    invoke-direct {p0}, Lgdg;->getMediaType()Lpaa;
