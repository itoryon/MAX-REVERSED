...
.method public final d()Lbb9;
    ...
    iget-object v4, v1, Landroidx/work/WorkerParameters;->b:Lw35;

    iget-object v1, v1, Landroidx/work/WorkerParameters;->b:Lw35;

    const-string v5, "tracer_sample_file_path"

    invoke-virtual {v4, v5}, Lw35;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v4, v5, v6}, Lw35;->c(Ljava/lang/String;J)J
    ...
    invoke-virtual {v1, v4}, Lw35;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    const-string v5, "tracer_version_code"

    invoke-virtual {v1, v5, v7, v8}, Lw35;->c(Ljava/lang/String;J)J
    ...
    invoke-static {v1, v0}, Ltfi;->f0(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/PackageInfo;

    move-result-object v0

    invoke-static {v0}, Lc6g;->A(Landroid/content/pm/PackageInfo;)J
...
.method public final e(Ljava/lang/String;Ljava/lang/Long;)Ljava/lang/String;
    ...
    iget-object v3, p0, Landroidx/work/WorkerParameters;->b:Lw35;

    iget-object v4, p0, Landroidx/work/WorkerParameters;->b:Lw35;

    const-string v5, "tracer_custom_properties_keys"

    invoke-virtual {v3, v5}, Lw35;->e(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-virtual {v4, v8}, Lw35;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v3, Li3i;->a:Li3i;

    sget-object v3, Li3i;->e:Lasf;
    ...
    :goto_1
    invoke-virtual {v3}, Lasf;->b()V

    iget-object v3, v3, Lasf;->f:Lxmh;
    ...
    :cond_6
    iget-object v6, v3, Lxmh;->n:Ljava/util/Map;

    invoke-static {v2, v6}, Lop9;->S0(Ljava/util/Map;Ljava/util/Map;)Ljava/util/LinkedHashMap;

    move-result-object v2

    invoke-static {v3, v5, v2, v7}, Lxmh;->a(Lxmh;ZLjava/util/Map;I)Lxmh;
    ...
    invoke-static {v2}, Ltfa;->a(Ljava/util/Date;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v6}, Lw35;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4, p1}, Lw35;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4, p1, v5}, Lw35;->a(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v4, p1, v7, v8}, Lw35;->c(Ljava/lang/String;J)J
    ...
    :cond_9
    iget-object p1, p0, Landroidx/work/WorkerParameters;->b:Lw35;
    ...
    invoke-virtual {v4, v3}, Lw35;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p1, v3}, Lv5a;-><init>(I)V

    new-instance v3, Lev4;

    invoke-direct {v3, p1}, Lev4;-><init>(Lv5a;)V
    ...
    invoke-direct {v5, v4, v7, v3}, Ldu6;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-direct {v0, p1, v5}, Lwxc;-><init>(Ljava/lang/String;Ln48;)V

    invoke-virtual {v2}, Lorg/json/JSONObject;->toString()Ljava/lang/String;

    sget-object p1, Li3i;->h:Lzlh;
    ...
    invoke-virtual {p1, v0}, Lb58;->b(Lwxc;)Lq48;

    move-result-object p1

    :try_start_0
    iget-object v0, p1, Lq48;->d:Ljava/io/Closeable;

    check-cast v0, Ldu6;

    new-instance v2, Lorg/json/JSONObject;

    iget-object v0, v0, Ldu6;->c:Ljava/lang/Object;

    check-cast v0, [B

    invoke-static {v0}, Loch;->G0([B)Ljava/lang/String;

    move-result-object v0

    invoke-direct {v2, v0}, Lorg/json/JSONObject;-><init>(Ljava/lang/String;)V

    iget-object v0, p0, Landroidx/work/WorkerParameters;->b:Lw35;
    ...
    invoke-virtual {p0, p2}, Lw35;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    invoke-static {v2, v0, p0}, Lgq2;->O(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final f(Ljava/io/File;Ljava/lang/String;)V
    ...
    iget-object v1, v0, Landroidx/work/WorkerParameters;->b:Lw35;

    const-string v2, "tracer_feature_uze_gzip"

    const/4 v3, 0x1

    invoke-virtual {v1, v2, v3}, Lw35;->a(Ljava/lang/String;Z)Z
    ...
    invoke-static {v4, v5, v6, v2}, Loch;->J0(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v5}, Lge8;->S(Ljava/io/File;)V
    ...
    invoke-static {v5, p0}, Lzw6;->D0(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object p0

    :try_start_0
    invoke-static {p1, p0}, Lkvl;->a(Ljava/io/File;Ljava/io/File;)V
    :try_end_0
    ...
    sget-object v1, Lzwk;->b:Leye;

    invoke-interface {p0, v1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    instance-of v1, p0, Lev4;
    ...
    invoke-direct {v4, p0}, Lev4;-><init>(Lv5a;)V

    move-object p0, v4

    :cond_3
    invoke-virtual {p0}, Lev4;->b()Ljava/lang/String;
    ...
    invoke-direct {v4, v1, p1}, Lgt0;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v1, v6, v7, v5, v4}, Lm48;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ln48;)V
    ...
    invoke-direct {v1, v3, p2}, Lb66;-><init>(Ljava/lang/String;Ljava/util/List;)V

    new-instance p2, Lwxc;

    invoke-direct {p2, p0, v1}, Lwxc;-><init>(Ljava/lang/String;Ln48;)V

    :try_start_1
    sget-object p0, Li3i;->h:Lzlh;
    ...
    invoke-virtual {p0, p2}, Lb58;->b(Lwxc;)Lq48;
    ...
    iget-object v3, p0, Lq48;->d:Ljava/io/Closeable;

    check-cast v3, Ldu6;

    iget-object v3, v3, Ldu6;->c:Ljava/lang/Object;
    ...
    iget-object v4, v0, Landroidx/work/WorkerParameters;->b:Lw35;
    ...
    invoke-virtual {v0, v5}, Lw35;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v5, "{"

    invoke-static {v3, v5, v2}, Loch;->L0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    :try_start_4
    invoke-static {v2, v4, v0}, Lgq2;->O(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_6
    invoke-static {p0, p2}, Lg09;->m(Ljava/io/Closeable;Ljava/lang/Throwable;)V
