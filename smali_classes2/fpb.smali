...
.method public final b(Ll5i;)V
    ...
    iget-object v2, v1, Ll5i;->d:Ljava/lang/Object;
    ...
    iget-object v2, v0, Lwpb;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, Lfpb;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v3}, Lepb;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_5
    :goto_1
    iget-boolean v3, v0, Lfpb;->g:Z

    if-eqz v3, :cond_7

    iget-object v3, v0, Lfpb;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Ldpb;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_7
    :goto_2
    iget-boolean v1, v0, Lwpb;->d:Z

    if-eqz v1, :cond_8

    iget-object v0, v0, Lwpb;->c:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v0}, Lepb;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v6}, Lepb;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
