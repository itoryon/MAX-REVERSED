...
.method public static i(Landroid/content/Context;Leye;Ljava/io/File;Ljava/lang/String;Ljava/lang/Long;Ljava/util/Map;I)V
    ...
    sget-object v6, Lg3i;->d:Ljava/lang/reflect/Method;
    ...
    invoke-static {v7, v8}, Ltfi;->f0(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/PackageInfo;

    move-result-object v7

    invoke-static {v7}, Lc6g;->A(Landroid/content/pm/PackageInfo;)J
    ...
    invoke-direct {v9, v10, v11}, Lcx4;-><init>(IZ)V

    iget-object v10, v9, Lcx4;->a:Ljava/lang/Object;
    ...
    iget-object v13, v13, Leye;->b:Ljava/lang/String;

    invoke-virtual {v9, v12, v13}, Lcx4;->D(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v13, v14}, Lcx4;->D(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v3, v5}, Lcx4;->D(Ljava/lang/String;Ljava/lang/String;)V

    const-string v3, "tracer_sample_uuid"

    invoke-virtual {v9, v3, v2}, Lcx4;->D(Ljava/lang/String;Ljava/lang/String;)V

    const-string v3, "tracer_feature_tag"

    invoke-virtual {v9, v3, v1}, Lcx4;->D(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v0}, Lcx4;->C(Ljava/util/Map;)V

    if-eqz v6, :cond_2

    const-string v0, "tracer_trace_id"

    iget-object v1, v6, Lg3i;->a:Ljava/lang/String;

    invoke-virtual {v9, v0, v1}, Lcx4;->D(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "tracer_span_id"

    iget-object v1, v6, Lg3i;->b:Ljava/lang/String;

    invoke-virtual {v9, v0, v1}, Lcx4;->D(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "tracer_trace_flags"

    iget-object v1, v6, Lg3i;->c:Ljava/lang/String;
    ...
    invoke-virtual {v1, v5}, Landroidx/work/WorkRequest$Builder;->setConstraints(Lei4;)Landroidx/work/WorkRequest$Builder;
    ...
    invoke-static/range {p0 .. p0}, Lb5k;->d(Landroid/content/Context;)Lb5k;

    move-result-object v1

    invoke-virtual {v1, v0}, Lb5k;->b(Landroidx/work/WorkRequest;)V
