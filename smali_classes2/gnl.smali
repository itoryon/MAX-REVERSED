...
.method public static d(Lz61;)[B
    ...
    invoke-virtual {p0, v7, v8, v9}, Lz61;->read([BII)I

    move-result v9

    if-ne v9, v5, :cond_0

    invoke-static {v0, v4}, Lgnl;->a(Ljava/util/ArrayDeque;I)[B
    ...
    :cond_5
    invoke-virtual {p0}, Lz61;->read()I

    move-result p0

    if-ne p0, v5, :cond_6

    invoke-static {v0, v6}, Lgnl;->a(Ljava/util/ArrayDeque;I)[B
